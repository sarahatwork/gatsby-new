...
const EXCLUDE_KEYS = {
  ...
  _.each(exampleValue, (value, key) => {
    ...
    } else if (nodes[0].internal.type !== `File` && (_.isString(value) && !_.isEmpty(value) && shouldInferFile(nodes, nextSelector, value) || _.isArray(value) && _.isString(value[0]) && !_.isEmpty(value[0]) && shouldInferFile(nodes, `${nextSelector}[0]`, value[0]))) {
